...
// ========== PRODUCTS COMPONENT ==========
// Displays all products in a grid and shows detailed modal when clicked
export default function Products() {
  // Track which product modal is open
  const [selectedProduct, setSelectedProduct] = useState(null);
  // Track selected category filter
  const [selectedCategory, setSelectedCategory] = useState('All');
  // Track selected size for the product
  const [selectedSize, setSelectedSize] = useState(null);
  // Track selected color for the product
      ...
      {selectedProduct && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            {/* ========== SIZE & FIT TABLE ========== */}
            {/* Full-width section below the product details */}
            <div className="modal-section-full">
              ...
              <div className="size-fit-table-wrapper">
                <table className="size-fit-table">
                  <thead>
                    <tr>
                      {/* Determine which columns to show based on product */}
                      <th>Size</th>
